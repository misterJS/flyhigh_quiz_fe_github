...
<template>
  <div class="min-h-screen bg-[#FAFAFA] pb-24">
    ...
    <section class="px-4 mt-3">
      <p class="text-sm font-normal text-gray-900 mb-2">
        Subjects
      </p>
      <div class="flex items-center gap-3 overflow-x-auto no-scrollbar pb-1">
        ...
        >
          <div
            class="w-14 h-14 rounded-full grid place-items-center border"
    ...
    <section class="px-4 mt-4">
      ...
      <div class="space-y-3">
        ...
        >
          ...
          >
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-xs text-gray-500 mt-0.5 mb-2 line-clamp-2">
                {{ q.description || subtext }}
              </p>
              <div class="grid grid-cols-2 gap-y-1 text-[12px] text-gray-800">
                <div class="flex items-center gap-1">
                  <i class="fas fa-book text-gray-400" />{{ q.totalQuiz }} Modul
                </div>
                <div class="flex items-center gap-1 justify-end">
                  <i class="fas fa-clock text-gray-400" />{{ q.totalHour }}
                </div>
                <div class="flex items-center gap-1 col-span-2">
                  <i class="fas fa-user text-gray-400" />{{ q.submittedCount || 0 }} Student
                </div>
              </div>
            </div>
          </router-link>
          ...
          >
            <i class="fas fa-bookmark text-[#2563EB]" />
          </button>
        ...
        <div
          v-if="!loading && !savedQuizzes.length"
