    ...
    <section class="relative h-[46vh] grid-bg bg-[#0B63F6] text-white">
      <div class="h-full max-w-sm mx-auto px-6 pt-10 flex flex-col items-center">
        ...
        <div class="text-center">
          <h2 class="text-[24px] leading-tight font-semibold">
            Create Your Account
          </h2>
      ...
      <div class="max-w-sm mx-auto -mt-16 bg-white rounded-2xl shadow-md border border-gray-200 px-5 py-5 space-y-4">
        ...
        <div>
          ...
          <div class="relative">
            ...
            >
              <i :class="showConfirmPassword ? 'far fa-eye-slash' : 'far fa-eye'" />
            </button>
          </div>
        </div>
        ...
        <div class="max-w-[360px] w-full bg-white rounded-[22px] shadow-xl overflow-hidden">
          <div class="bg-[#EAF2FF] h-36 flex items-center justify-center relative">
            <div class="w-16 h-16 rounded-full bg-white/80 flex items-center justify-center relative">
              <i class="fas fa-user text-[#0B63F6] text-2xl" />
              <i class="fas fa-check-circle text-[#0B63F6] text-lg absolute -right-1 -bottom-1 bg-white rounded-full" />
            </div>
            <span class="absolute left-6 top-6 w-1.5 h-1.5 bg-orange-400 rounded-full" />
            <span class="absolute right-8 top-7 w-1.5 h-1.5 bg-blue-500 rounded-full" />
            <span class="absolute left-10 bottom-6 w-1.5 h-1.5 bg-blue-500 rounded-full" />
            <span class="absolute right-10 bottom-6 w-1.5 h-1.5 bg-orange-400 rounded-full" />
          </div>
