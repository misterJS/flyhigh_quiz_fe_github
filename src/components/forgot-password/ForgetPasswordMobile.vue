<template>
    ...
    <main class="flex-1">
      <div class="relative z-20 max-w-sm mx-auto px-6 -mt-12">
        <div class="bg-white rounded-2xl shadow-xl border border-gray-200 p-5">
          ...
          <div class="relative">
            <input
              ...
              @keyup.enter="send"
            >
            <i class="fas fa-envelope absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" />
          </div>
        ...
        <div class="text-center mt-6">
          ...
          <button
            class="ml-1 text-sm font-semibold text-[#1877F2]"
            @click="goLogin"
          >
            Sign in
          </button>
  ...
  <div
    v-else
    class="min-h-screen relative flex items-center justify-center bg-[#1877F2]"
  >
    <!-- grid pattern -->
    <div
